...
public class BuckBoostConverter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buck_boost_converter);
        ...
        Button btnknow= findViewById(R.id.knowMoreBuckBoost);
        btnknow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), knowBuckBoost.class);
                startActivity(i);
            }
        });
